<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="createAuction.aspx.cs" Inherits="Lab1.createAuction" %>
    ...
    <div class="container col-6">
        <div class="card">
            <div class="card-header text-center">
                <asp:Label ID="lblCreateNewCustomer" runat="server" Text="New Auction Request" Class="h3 m-2"></asp:Label>
            </div>
